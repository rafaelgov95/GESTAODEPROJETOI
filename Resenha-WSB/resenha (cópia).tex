...
\node[root] {What Flowers}
% The first level, as children of the initial tree
child {node[level 2] (c1) {Sistema GVR}}
child {node[level 2] (c2) {Android}}
child {node[level 2] (c3) {WF}};

% The second level, relatively positioned nodes
\begin{scope}[every node/.style={level 3}]
\node [below of = c1, xshift=15pt] (c11) {Vendas};
\node [below of = c11] (c12) {Estoque};
\node [below of = c12] (c13) {Relatórios};

\node [below of = c2, xshift=15pt] (c21) {Front};
\node [below of = c21] (c22) {Banco};
\node [below of = c22] (c23) {Conexao WF};
\node [below of = c23] (c24) {Testes};

\node [below of = c3, xshift=15	pt] (c31) {Desenvolvimento};
\node [below of = c31] (c32) {Codificação};
\node [below of = c32] (c33) {Cole. Imagens};
\node [below of = c33] (c34) {Treinamento};
\node [below of = c34] (c35) {Conexão};
\end{scope}
